...
```
    ...
    ## alpha_Intercept      0.25      0.03     0.19     0.31 1.00     1017      981
    ## gamma_Intercept      0.33      0.03     0.27     0.38 1.00     1244     1161
    ## lambda_Intercept     1.23      0.30     0.77     1.93 1.00     1272     1338
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.07      0.00     0.07     0.08 1.00     1517     1811
    ## 
...
```
    ...
    ## Regression Coefficients:
    ##                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## alpha_Intercept      0.21      0.03     0.15     0.27 1.00     1109      946
    ## gamma_Intercept      0.36      0.03     0.31     0.42 1.00     1161     1243
    ## lambda_Intercept     1.03      0.19     0.73     1.46 1.00     1393     1669
    ## A_Intercept          0.06      0.01     0.05     0.08 1.00     2159     1548
    ## phi_Intercept       -0.84      0.11    -1.06    -0.61 1.00     2406     1918
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.06      0.00     0.05     0.07 1.00     2404     1769
    ## 
    ## Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
    ## and Tail_ESS are effective sample size measures, and Rhat is the potential
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
